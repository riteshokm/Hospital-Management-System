        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch(item.getItemId()) {
                    ...
                    case R.id.add:
                        Intent intent1 = new Intent(Doctor.this, Add_DB.class);
                        intent1.putExtra("TypeOfPerson","Doctor");
                        startActivity(intent1);
                        break;
                    case R.id.remove:
                        Intent intent2 = new Intent(Doctor.this, On_delete.class);
                        intent2.putExtra("TypeOfPerson","Doctor");
                        startActivity(intent2);
                        break;
                    case R.id.update:
                        Intent intent3 = new Intent(Doctor.this, Update_DB.class);
                        intent3.putExtra("TypeOfPerson","Doctor");
                        startActivity(intent3);
                        break;
                    case R.id.search:
                        Intent intent4 = new Intent(Doctor.this, Search_DB.class);
                        intent4.putExtra("TypeOfPerson","Doctor");
